             ...
             <label className="flex cursor-pointer items-center gap-3">
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <input
                  type="radio"
                  name="category"
                  checked={category === "Thực phẩm"}
                  onChange={() => handleCategoryChange("Thực phẩm")}
                  className="h-4 w-4"
                />
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <input
                  type="radio"
                  name="category"
                  checked={category === "Sử dụng trong nhà"}
                  onChange={() =>
                    handleCategoryChange("Sử dụng trong nhà")
                  }
                  className="h-4 w-4"
                />
