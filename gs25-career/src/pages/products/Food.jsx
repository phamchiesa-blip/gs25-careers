...
import {food} from "../../data/products";
             ...
             <label className="flex cursor-pointer items-center gap-3">
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <input
                  type="radio"
                  name="category"
                  checked={category === "Món Hàn"}
                  onChange={() => handleCategoryChange("Món Hàn")}
                  className="h-4 w-4"
                />
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <input
                  type="radio"
                  name="category"
                  checked={category === "Bữa ăn hàng ngày"}
                  onChange={() =>
                    handleCategoryChange("Bữa ăn hàng ngày")
                  }
                  className="h-4 w-4"
                />
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <input
                  type="radio"
                  name="category"
                  checked={category === "Món nước"}
                  onChange={() =>
                    handleCategoryChange("Món nước")
                  }
                  className="h-4 w-4"
                />
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <input
                  type="radio"
                  name="category"
                  checked={category === "Các loại bánh"}
                  onChange={() =>
                    handleCategoryChange("Các loại bánh")
                  }
                  className="h-4 w-4"
                />
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <input
                  type="radio"
                  name="category"
                  checked={category === "Tráng miệng"}
                  onChange={() =>
                    handleCategoryChange("Tráng miệng")
                  }
                  className="h-4 w-4"
                />
