...
const StaffForm = () => {
  ...
  return (
    <>
        ...
        {/* Introduce */}
        <IntroduceForm jobName={'NHÂN VIÊN BÁN HÀNG'} time={"Toàn thời gian"} salary={"28.000/giờ"} type={"Khối Cửa hàng"} />
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-3xl p-6 sm:p-10 shadow-2xl mb-4">
            ...
            <h1 className="text-xl text-red-400 mb-4 font-bold">THÔNG TIN VỊ TRÍ: Nhân viên Bán hàng toàn thời gian/ Full-time:  </h1>
            <ul className="text-[#226FA1] font-semibold">
                <li className="mb-3 text-red-400">- Thu nhập: 28.000/giờ</li>
                ...
                <li className="mb-3">• Ca 1: 06h00 - 14h00</li>
                <li className="mb-3">• Ca 2: 10h00 - 18h00</li>
                <li className="mb-3">• Ca 3: 14h00 - 22h00</li>
