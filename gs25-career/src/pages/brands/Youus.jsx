...
import {youusData} from "../../data/categories";
...
const Youus = () => {
  ...
  let filteredProducts = [...youusData];
            ...
            <div className="space-y-4">
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <input
                  type="radio"
                  name="category"
                  checked={category === "Trà/Nước trái cây"}
                  onChange={() =>
                    handleCategoryChange("Trà/Nước trái cây")
                  }
                  className="h-4 w-4"
                />
